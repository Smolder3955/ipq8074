...
#define PLD_FW_READY_DELAY	100 /* 100 msec */
#define PLD_COLD_BOOT_MAX_WAIT_LIMIT 400
#define PLD_FW_READY_TIMEOUT 150
...
int pld_is_fw_ready(struct device *);
int pld_is_cold_boot_cal_done(struct device *);
