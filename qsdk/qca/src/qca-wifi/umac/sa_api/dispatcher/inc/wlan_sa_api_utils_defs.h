...
#ifndef _WLAN_SA_API_UTILS_DEFS_H_
#define _WLAN_SA_API_UTILS_DEFS_H_
...
struct smartantenna_ops {
	...
	int  (*sa_peer_connect) (void **ccp, struct  sa_node_info *node_info);
	int  (*sa_peer_disconnect) (void *ccp);
...
#endif /* _WLAN_SA_API_UTILS_DEFS_H_*/
