...
DIFF_FEC_REG = ['8976','8937','8953','8076','8940','9607','8917','8920','807x','9206', 'sdm450']

# Same as DIFF_FEC_REG where additionally shadow region also needs to be set
FEC_SHADOW = ['9607', '9206']
