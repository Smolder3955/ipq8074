...
(function (root, factory) {
	...
	function GaugeObject(opts) {
		...
		var gaugeobject = {
			...
			I:0,
			blueColor: opts.blueColor || "#1379a8",
			yellowColor: opts.yellowColor || "#FF9900",
			redColor: opts.redColor || "#e2222f",
			greyColor: opts.greyColor || "#c8c8c8",
		...
		gaugeobject.updateGauges = function(theNumber) {
			if (theNumber > gaugeobject.overload){
				...
				gaugeobject.drawBand(0, theNumber, "#1379a8");
			}else{
				gaugeobject.drawBand(0, theNumber, "#1379a8");
			}
			gaugeobject.drawRestBand(0, 100, "#c8c8c8");
