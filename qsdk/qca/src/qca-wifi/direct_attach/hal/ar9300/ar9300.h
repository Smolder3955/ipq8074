...
extern void ar9300_get_chip_min_and_max_powers(struct ath_hal *ah,
                                               int8_t *max_tx_power,
                                               int8_t *min_tx_power);
extern void ar9300_fill_hal_chans_from_regdb(struct ath_hal *ah,
                                             uint16_t freq,
                                             int8_t maxregpower,
                                             int8_t maxpower,
                                             int8_t minpower,
                                             uint32_t flags,
                                             int index);
extern void ar9300_set_sc(struct ath_hal *ah, HAL_SOFTC sc);
...
extern  uint16_t ar9300_get_ah_devid(struct ath_hal *ah);
