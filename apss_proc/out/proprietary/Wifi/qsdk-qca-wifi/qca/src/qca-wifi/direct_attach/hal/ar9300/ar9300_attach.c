...
static const struct ath_hal_private ar9300hal = {
    {
        ...
        ar9300_get_chip_min_and_max_powers,/* ah_get_chip_min_and_max_powers */
        ar9300_fill_hal_chans_from_regdb,  /* ath_hal_fill_hal_chans_from_regdb */
		ar9300_set_sc,	  				   /* ath_hal_set_sc */
        ...
        ar9300_get_ah_devid,               /* ah_hal_get_ah_devid */
    ...
    struct hal_reg_parm *hal_conf_parm, HAL_STATUS *status)
{
    ...
    /* NB: memory is returned zero'd */
    ahp = qdf_mem_malloc(sizeof(struct ath_hal_9300));
    if (ahp == AH_NULL) {
        HDPRINTF(AH_NULL, HAL_DBG_UNMASKABLE,
