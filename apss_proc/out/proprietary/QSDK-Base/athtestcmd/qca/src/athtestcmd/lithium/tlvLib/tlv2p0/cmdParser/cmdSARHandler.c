...
// This is an auto-generated file from input/cmdSARHandler.s
#include "tlv2Inc.h"
...
void* initSAROpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CMDID, (A_UINT32)(((A_UINT32)&(pSARParms->cmdId)) - (A_UINT32)pSARParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CCK2GLIMIT, (A_UINT32)(((A_UINT32)&(pSARParms->CCK2gLimit)) - (A_UINT32)pSARParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OFDM2GLIMIT, (A_UINT32)(((A_UINT32)&(pSARParms->Ofdm2gLimit)) - (A_UINT32)pSARParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OFDM5GLIMIT, (A_UINT32)(((A_UINT32)&(pSARParms->Ofdm5gLimit)) - (A_UINT32)pSARParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CHAIN, (A_UINT32)(((A_UINT32)&(pSARParms->chain)) - (A_UINT32)pSARParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_INDEX8, (A_UINT32)(((A_UINT32)&(pSARParms->index8)) - (A_UINT32)pSARParms), pParmsOffset);
...
void* initSARRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT32)&(pSARRSPParms->status)) - (A_UINT32)pSARRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CCK2GLIMIT, (A_UINT32)(((A_UINT32)&(pSARRSPParms->CCK2gLimit)) - (A_UINT32)pSARRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OFDM2GLIMIT, (A_UINT32)(((A_UINT32)&(pSARRSPParms->Ofdm2gLimit)) - (A_UINT32)pSARRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OFDM5GLIMIT, (A_UINT32)(((A_UINT32)&(pSARRSPParms->Ofdm5gLimit)) - (A_UINT32)pSARRSPParms), pParmsOffset);
