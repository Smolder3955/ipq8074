...
#define RMNET_MAP_DEAGGR_HEADROOM (192)
#define RMNET_MAP_ETHERNET_HEADER (32)
#define RMNET_MAP_DEAGGR_SPACING  (RMNET_MAP_ETHERNET_HEADER + RMNET_MAP_DEAGGR_HEADROOM)
/******************************************************************************/
