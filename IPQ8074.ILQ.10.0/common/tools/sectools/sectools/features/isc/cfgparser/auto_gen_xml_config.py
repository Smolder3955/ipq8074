...
class complex_elf_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, has_hash_table=None, has_license_manager_segment=None, max_elf_segments=None, image_type=None, hash_seg_placement=None, validate_ph_addrs=None, validate_vir_addrs=None):
