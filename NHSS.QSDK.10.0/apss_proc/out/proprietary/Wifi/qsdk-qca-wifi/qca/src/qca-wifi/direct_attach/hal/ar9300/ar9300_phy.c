...
/* Previously ctrl rate was limited to 2 Mbps (cix :1) but since the
 * intention is to disable 1 and 2 Mbps, so increased the cix to 2 and 3
 * so that 5.5 and 11 Mbps can be used as ctrl rate.
 */
