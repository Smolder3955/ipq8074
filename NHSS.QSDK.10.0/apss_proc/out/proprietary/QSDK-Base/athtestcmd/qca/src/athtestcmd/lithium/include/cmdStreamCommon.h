...
// headerExtended value when CMD_STERAM_HEADER_EXTENDED_SEGMENT is set in header
        //if the second to the last byte of extended header is not 0
            //number of segments: the second to the last byte of extended header
            //segment number: the last byte of extended header
		//else
            //number of segments: the second to the last 4 bits of extended header
            //segment number: the last 4 bits of extended header
...
#define CMD_STREAM_HEADER_EXTENDED_SEGMENT_NUM_SHIFT_255    0
#define CMD_STREAM_HEADER_EXTENDED_SEGMENT_NUM_MASK_255		0x000000FF
#define CMD_STREAM_HEADER_EXTENDED_TOTAL_SEGMENTS_SHIFT_255	8
#define CMD_STREAM_HEADER_EXTENDED_TOTAL_SEGMENTS_MASK_255	0x0000FF00

#define CMD_STREAM_HEADER_EXTENDED_EXTRA_SEGMENTS_MASK		0x0000FF00
// others
