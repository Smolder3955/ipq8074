...
void* initTXSTATUSOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pTXSTATUSParms->radioId = pParmDict[PARM_RADIOID].v.valU8;
    pTXSTATUSParms->stopTx = pParmDict[PARM_STOPTX].v.valU8;
    pTXSTATUSParms->needReport = pParmDict[PARM_NEEDREPORT].v.valU8;

    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT32)&(pTXSTATUSParms->radioId)) - (A_UINT32)pTXSTATUSParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("TXSTATUSOp: radioId %u\n", pTXSTATUSParms->radioId);
...
void* initTXSTATUSRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Populate the parm structure with initial values
    pTXSTATUSRSPParms->radioId = pParmDict[PARM_RADIOID].v.valU8;
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT32)&(pTXSTATUSRSPParms->radioId)) - (A_UINT32)pTXSTATUSRSPParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("TXSTATUSRSPOp: radioId %u\n", pTXSTATUSRSPParms->radioId);
