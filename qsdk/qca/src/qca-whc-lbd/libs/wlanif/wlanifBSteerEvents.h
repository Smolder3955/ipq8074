...
/**
 * @brief Inform wlanif that a STA associated on a remote node has Client
 *        Classification group to be updated.
 *
 * @param [in] handle  the handle returned from wlanifBSteerEventsCreate()
 * @param [in] staAddr  the MAC address of the STA whose association changed
 * @param [in] clientClassGroup  the client classification group the STA
 *                               belongs to
 *
 * @return LBD_OK on success; otherwise LBD_NOK
 */
