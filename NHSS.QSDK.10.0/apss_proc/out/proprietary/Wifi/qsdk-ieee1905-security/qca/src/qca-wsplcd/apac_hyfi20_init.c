...
#define NGHT_STD "ng"
#define NAHT_STD "na"
#define AXAHE_STD "ahe"
#define AXGHE_STD "ghe"
...
{
    const int TOKEN_LEN = IFNAMSIZ + 12; /*Increased the interface spacing token len*/
...
static int apac_config_nonpbc(char *buf, /* input */
        apacHyfi20Data_t *pData/* output */ )
{
    const int TOKEN_LEN = IFNAMSIZ + 5; /*Increased the interface spacing token len*/
