...
/**
 * @brief Check if the VAP is in included interface list
 *
 * @param [in] state the handle returned from
 *                   wlanifBSteerControlCreate()
 * @param [in] sysIndex OS-specific identifier for the interface
 *
 * @return LBD_STATUS LBD_OK if the vap is in included list, LBD_NOK
 *                    otherwise
 */
...
#define WLANIFBSTEERCONTROL_CLIENT_CLASSIFICATION_ENABLE "ClientClassificationEnable"
...
#define WLANIFBSTEERCONTROL_UNIFIED_STATS_ENABLE "UnifiedStatsEnable"
#define WLANIFBSTEERCONTROL_NL_STEER_MULTICAST_ENABLE "WlanSteerMulticast"
#define WLANIFBSTEERCONTROL_ACK_RSSI_ENABLE "EnableAckRSSI"
#define WLANIFBSTEERCONTROL_LOG_MOD_COUNTER "LogModCounter"
