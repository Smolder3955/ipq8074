...
void* initLMTXINITOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    pLMTXINITParms->phyId = pParmDict[PARM_PHYID].v.valU8;
    pLMTXINITParms->pad1 = pParmDict[PARM_PAD1].v.valU8;
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT32)&(pLMTXINITParms->phyId)) - (A_UINT32)pLMTXINITParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD1, (A_UINT32)(((A_UINT32)&(pLMTXINITParms->pad1)) - (A_UINT32)pLMTXINITParms), pParmsOffset);
...
//#ifdef _DEBUG
    ...
    A_PRINTF("LMTXINITOp: phyId %u\n", pLMTXINITParms->phyId);
    A_PRINTF("LMTXINITOp: pad1 %u\n", pLMTXINITParms->pad1);
