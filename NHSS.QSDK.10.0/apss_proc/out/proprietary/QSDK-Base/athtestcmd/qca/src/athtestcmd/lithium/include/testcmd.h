...
#define FTM_TX_ACK_REQUEST_MASK             0x00000080
#define FTM_TX_ACK_REQUEST_MASK_SHIFT       7
#define TCMD_SET_OFDMA_MASK                 0x00000100
#define TCMD_SET_OFDMA_SHIFT                8
#define TCMD_SET_DTIM_MODE_MASK             0x10000000
#define TCMD_NO_TX_AFTER_CAL_MASK           0x08000000
#define TCMD_NO_TX_AFTER_CAL_SHIFT          27
#define TCMD_SET_DTIM_MODE_SHIFT            28
#define TCMD_DO_NF_CAL_MASK                 0x20000000
#define TCMD_DO_NF_CAL_SHIFT                29
...
typedef enum {
    TCMD_RF_SYNTH_TYPE_REGULAR_SYNTH=0,
    TCMD_RF_SYNTH_TYPE_DTIM_SYNTH   =1,
} TCMD_RF_SYNTH_TYPE;
