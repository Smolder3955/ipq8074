...
=============================================================================
 ...
 $Header: //components/rel/boot.bf/3.3.1/boot_images/core/storage/tools/fh_loader/fh_loader.c#5 $
    ...
    */
    ...
    while (1)
    {
        ...
        else
        {
            ...
            CopyString (tx_buffer, xml_buffer, strlen (tx_buffer), PacketLoc, pch - &xml_buffer[PacketLoc], FIREHOSE_TX_BUFFER_SIZE, sizeof(tx_buffer));
            AppendToBuffer (tx_buffer, " />\n</data>", FIREHOSE_TX_BUFFER_SIZE);
