...
static void ieee1905EventDispatch( u_int8_t *frame, u_int32_t len, u_int32_t type )
{
    ...
    switch( type )
    {
        ...
        case IEEE1905_MSG_TYPE_AP_AUTOCONFIGURATION_RENEW:
            ...
            break;
        case IEEE1905_MSG_TYPE_ACK:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_ACK, frame, len );
            break;
        case IEEE1905_MSG_TYPE_AP_CAP_QUERY:
        case IEEE1905_MSG_TYPE_AP_CAP_REPORT:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_AP_CAP, frame, len );
            break;
        case IEEE1905_MSG_TYPE_MAP_POLICY_CONFIG:
            ieee1905S.ieee1905ReceiveCallback(IEEE1905_EVENT_MAP_POLICY, frame, len );
            break;
        case IEEE1905_MSG_TYPE_CHANNEL_PREFERENCE_QUERY:
        case IEEE1905_MSG_TYPE_CHANNEL_PREFERENCE_REPORT:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_CHANNEL_PREFERENCE, frame, len );
            break;
        case IEEE1905_MSG_TYPE_CHANNEL_SELECTION_REQUEST:
        case IEEE1905_MSG_TYPE_CHANNEL_SELECTION_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_CHANNEL_SELECTION, frame, len );
            break;
        case IEEE1905_MSG_TYPE_OPERATING_CHANNEL_REPORT:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_OPERATING_CHANNEL, frame, len );
            break;
        case IEEE1905_MSG_TYPE_CLIENT_CAPABILITY_QUERY:
        case IEEE1905_MSG_TYPE_CLIENT_CAPABILITY_REPORT:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_CLIENT_CAPABILITY, frame, len );
            break;
        case IEEE1905_MSG_TYPE_AP_METRICS_QUERY:
        case IEEE1905_MSG_TYPE_AP_METRICS_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_AP_METRICS, frame, len );
            break;
        case IEEE1905_MSG_TYPE_ASSOC_STA_LINK_METRIC_QUERY:
        case IEEE1905_MSG_TYPE_ASSOC_STA_LINK_METRIC_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_ASSOC_STA_LINK_METRIC, frame, len );
            break;
        case IEEE1905_MSG_TYPE_UNASSOC_STA_METRIC_REQUEST:
        case IEEE1905_MSG_TYPE_UNASSOC_STA_METRIC_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_UNASSOC_STA_METRIC, frame, len );
            break;
        case IEEE1905_MSG_TYPE_BEACON_METRICS_QUERY:
        case IEEE1905_MSG_TYPE_BEACON_METRICS_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_BEACON_METRICS, frame, len );
            break;
        case IEEE1905_MSG_TYPE_COMBINED_INFRASTRUCTURE_METRICS:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_COMBINED_INFRASTRUCTURE_METRICS, frame, len );
            break;
        case IEEE1905_MSG_TYPE_CLIENT_STEERING_REQUEST:
        case IEEE1905_MSG_TYPE_CLIENT_STEERING_BTM_REPORT:
        case IEEE1905_MSG_TYPE_CLIENT_ASSOC_CONTROL_REQUEST:
        case IEEE1905_MSG_TYPE_CLIENT_STEERING_COMPLETED:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_CLIENT_STEERING, frame, len );
            break;
        case IEEE1905_MSG_TYPE_HIGHER_LAYER_PAYLOAD:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_HIGHER_LAYER_PAYLOAD, frame, len );
            break;
        case IEEE1905_MSG_TYPE_BACKHAUL_STEERING_REQUEST:
        case IEEE1905_MSG_TYPE_BACKHAUL_STEERING_RESPONSE:
            ieee1905S.ieee1905ReceiveCallback( IEEE1905_EVENT_BACKHAUL_OPTIMIZATION, frame, len );
            break;
        default:
            break;
    }
...
IEEE1905_BOOL ieee1905TLVIsFragmentationRequired( u_int32_t curLen,
                                                  u_int32_t tlvPayloadLen )
{
    return curLen + IEEE1905_TLV_LEN( tlvPayloadLen ) +
           IEEE1905_TLV_LEN( 0 ) > ETH_FRAME_LEN;
}
