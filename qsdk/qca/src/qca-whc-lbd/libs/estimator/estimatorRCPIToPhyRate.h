 ...
 *
 * @param [in] the module to use for any debug logs
 * @param [in] rssi  rssi in dB
 * @param [in] chanWidth  the channel width over which the RSSI was measured
 *
...
lbd_rssi_t estimatorRCPIToPhyRateConvertRSSIFromDbmToDb(struct dbgModule *dbgModule,
        int8_t rssi, wlanif_chwidth_e chanWidth);
