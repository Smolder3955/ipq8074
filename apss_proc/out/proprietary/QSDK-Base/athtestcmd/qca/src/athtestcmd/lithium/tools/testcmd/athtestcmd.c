...
--tx <frame/tx99/tx100/sine/off> \n\
      ...
      --txrate < 0 - 1L / 1 - 2L / 2 - 5L / 3 - 11L / 4 - 2S / 5 - 5S / 6 - 11S / 10 - 6Mbps / 11 - 9 Mbps / 12 - 12 Mbps / 13 - 18 Mbps / 14 - 24 Mbps / 15 - 36 Mbps / 16 - 48 Mbps / 17 - 54 Mbps / 20 - MCS0 / 21 - MCS1 / 22 - MCS2 / 23 - MCS3 / 24 - MCS4 / 25 -MCS5 / 26 - MCS6 / 27 - MCS7 / 28 - MCS8 / 29 - MCS9 / 30 - MCS / 31 - MCS11 / -1 - CW>\n\
      --rateBw < -1 - CW / 0 - CCK / 1 - LegacyOFDM / 2 - HT20 / 3- HT40 / 4 - VHT20 / 5 - VHT40 / 6 - VHT80 / 7 - VHT80P80 / 8 - HE20 / 9 - HE40 / 10 - HE80 / 11 - HE80P80 / 12 - OFDMA / 13 - OFDMA_HE80P80>\n\
	...
	* ht20/vht20 ==> primary 20\n\
	* ht40plus/vht40plus ==> primary low\n\
	* ht40minus/vht40minus ==> primary high\n\
      >\n\
...
int main (int argc, char **argv)
{
    ...
    while (1) {
        ...
        case 't':
            ...
            tlv2Construct = TRUE;
            miscFlags |= TX_STATUS_PER_RATE_MASK;
#else
            tlvConstruct = TRUE;
